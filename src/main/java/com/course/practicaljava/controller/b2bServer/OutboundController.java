...
public class OutboundController {
    ...
    public OutboundController(ParntnerConfigService parnerConfigService) {
    ...
    @Operation(
            summary = "update config",description = "update config",
            responses = {
                    @ApiResponse(responseCode = "200", content = @Content(examples = {
                            @ExampleObject(name = "edi_partner_configs",
                                    summary = "result",
                                    description = "result",
